package com.dingwd.commons.util.jackson;

import com.dingwd.commons.constant.exceptions.DJsonException;
...
public class JacksonUtil {
    ...
    static {
        try {
            ...
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
...
//        objectMapper.registerModule(new GuavaModule());
    ...
    public static <V> V from(URL url, Class<V> type) {
        try {
            ...
            log.error("jackson from error, url:[{}], type:[{}] error:", url.getPath(), type, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static <V> V from(InputStream inputStream, Class<V> type) {
        try {
            ...
            log.error("jackson from error, type:[{}] error:", type, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static <V> V from(File file, Class<V> type) {
        try {
            ...
            log.error("jackson from error, file path:[{}], type:[{}] error:", file.getPath(), type, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static <V> V from(String json, Type type) {
        ...
        try {
            ...
            log.error("jackson from error, json:[{}], type:[{}] error:", json, type, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static Map<String, Object> fromMap(String json) {
        ...
        try {
            ...
            log.error("jackson from error, json:[{}] error:", json, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static <V> String toJSONString(List<V> list) {
        try {
            ...
            log.error("jackson to error, data:[{}] error:", list, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static <V> String toJSONString(V v) {
        try {
            ...
            log.error("jackson to error, data:[{}] error:", v, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static <V> void toFile(String path, List<V> list) {
        try (Writer writer = new FileWriter(new File(path), true)) {
            ...
            log.error("jackson to file error, path:[{}], list:[{}] error:", path, list, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static <V> void toFile(String path, V v) {
        try (Writer writer = new FileWriter(new File(path), true)) {
            ...
            log.error("jackson to file error, path:[{}], data:[{}] error:", path, v, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static String getAsString(String json, String key) {
        ...
        try {
            ...
            log.error("jackson get string error, json:[{}], key:[{}] error:", json, key, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static int getAsInt(String json, String key) {
        ...
        try {
            ...
            log.error("jackson get int error, json:[{}], key:[{}] error:", json, key, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static long getAsLong(String json, String key) {
        ...
        try {
            ...
            log.error("jackson get long error, json:[{}], key:[{}] error:", json, key, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static double getAsDouble(String json, String key) {
        ...
        try {
            ...
            log.error("jackson get double error, json:[{}], key:[{}] error:", json, key, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static BigInteger getAsBigInteger(String json, String key) {
        ...
        try {
            ...
            log.error("jackson get big integer error, json:[{}], key:[{}] error:", json, key, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static BigDecimal getAsBigDecimal(String json, String key) {
        ...
        try {
            ...
            log.error("jackson get big decimal error, json:[{}], key:[{}] error:", json, key, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static byte[] getAsBytes(String json, String key) {
        ...
        try {
            ...
            log.error("jackson get byte error, json:[{}], key:[{}] error:", json, key, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static <V> V getAsObject(String json, String key, Class<V> type) {
        ...
        try {
            ...
            log.error("jackson get list error, json:[{}], key:[{}], type:[{}] error:", json, key, type, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static JsonNode getAsJsonObject(String json, String key) {
        try {
            ...
            log.error("jackson get object from json error, json:[{}], key:[{}] error:", json, key, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static <V> String add(String json, String key, V value) {
        try {
            ...
            log.error("jackson add error, json:[{}], key:[{}], value:[{}] error:", json, key, value, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static String remove(String json, String key) {
        try {
            ...
            log.error("jackson remove error, json:[{}], key:[{}] error:", json, key, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static <V> String update(String json, String key, V value) {
        try {
            ...
            log.error("jackson update error, json:[{}], key:[{}], value:[{}] error:", json, key, value, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
    ...
    public static String format(String json) {
        try {
            ...
            log.error("jackson format json error, json:[{}] error:", json, e);
            throw new DJsonException(new DErrorMessage.MESSAGE(e.getMessage()));
        }
    }
